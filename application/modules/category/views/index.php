		...
		<div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
	            <div class="kt-portlet__head-actions">
		            ...
		            &nbsp;
                    <?php echo generate_button('category', 'authCreate', '<button class="btn btn-brand btn-elevate btn-icon-sm" onclick="return Actions.add();"><i class="la la-plus"></i>Tambah</button>'); ?>
	            </div>	
            </div>
        </div>
    </div>
            ...
            <form class="kt-form kt-form--label-right" method="POST" id="kt_modal_form">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="example-text-input" class="col-lg-3 col-sm-12 col-form-label">Nama Kategori</label>
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12">
                            <div class="kt-radio-inline">
                                <label class="kt-radio kt-radio--bold kt-radio--success">
                                    <input type="radio" checked name="categoryStatus" value="Y"> Aktif
                                    <span></span>
                                </label>
                                <label class="kt-radio kt-radio--bold kt-radio--danger">
                                    <input type="radio" name="categoryStatus" value="N"> Non Aktif
                                    <span></span>
                                </label>
                            </div>
                        </div>
        ...
        var initTable1 = function() {
            ...
            table.DataTable({
                ...
                columns: [
                    ...
                    {data: 'categoryName', className: 'text-center', width: 500},
                    {data: 'categoryStatus', className: 'text-center',},
        ...
        edit: function(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#categoryName").val(obj.data.categoryName);
                    $("input[name=categoryStatus][value='"+obj.data.categoryStatus+"']").prop("checked",true);
                }
            });
